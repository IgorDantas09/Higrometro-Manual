...
export default function App() {
  ...
  const setLpm = (id: number, value: string) => {
    setNozzles((prev) =>
      prev.map((n) => (n.id === id ? { ...n, lpm: value.replace(",", ".") } : n))
    );
  };
      ...
      <div style={{ maxWidth: 1400, margin: "0 auto" }}>
        ...
        <div style={cardStyle}>
          <div style={cardHeaderStyle}>
            <h2 style={cardTitleStyle}>1. Entrada de dados</h2>
          </div>
        ...
        {executado && (
          <>
            ...
            >
              ...
              <div style={cardStyle}>
                <div style={cardHeaderStyle}>
                  <h2 style={cardTitleStyle}>2. Gráfico de validação</h2>
                  <div
                    style={{
                      display: "flex",
                      gap: 8,
...
const nozzleGridStyle: React.CSSProperties = {
  display: "grid",
...
const statsGridPdfStyle: React.CSSProperties = {
  display: "grid",
...
const pdfStatCardStyle: React.CSSProperties = {
  background: "#ffffff",
  border: "1px solid #e2e8f0",
  borderRadius: 24,
  boxShadow: "0 1px 3px rgba(0,0,0,0.06)",
...
const pdfStatLabelStyle: React.CSSProperties = {
  fontSize: 12,
  color: "#000000",
  margin: 0,
  lineHeight: 1.2,
...
const pdfStatValueStyle: React.CSSProperties = {
  fontSize: 24,
  fontWeight: 700,
  color: "#000000",
  margin: "6px 0 0 0",
...
const pdfStatNoteStyle: React.CSSProperties = {
  marginTop: 6,
  fontSize: 11,
  color: "#000000",
  lineHeight: 1.25,
